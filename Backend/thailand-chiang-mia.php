    ...
    <div class="title1">
	  <div>
		<nav class="navbar navbar-expand-lg navbar-light bg-body-dark">
		  ...
		  <h1 style="color: white; padding: 12px; text-align: center; color: red;">Chianf-Mia</h1>
		  ...
		  <div class="description">
			<div style="color: white;">
				...
				<p>Chiang Mai, nestled in the mountainous region of northern Thailand, captivates visitors with its rich tapestry of culture, history, and natural beauty. A juxtaposition of ancient temples, bustling markets, and lush landscapes, this city exudes a serene charm that effortlessly blends tradition with modernity. From the iconic Wat Phra That Doi Suthep temple perched atop a verdant hill to the vibrant Night Bazaar pulsating with local crafts and culinary delights, Chiang Mai offers a sensory journey unlike any other. Adventure seekers can explore the surrounding mountains on thrilling treks, while those seeking tranquility can find solace in the city's numerous meditation retreats and serene riverside settings. With its warm hospitality and diverse array of experiences, Chiang Mai beckons travelers to immerse themselves in its timeless allure.</p>
			</div>
		  </div>
		  ...
		  <div class="container">
					...
					<div class="details">
						...
						<p> Here are the details for visiting Chiang-Mia,Thailand :</p>
						
						<b>Overview:</b>
						<ul>
							<li>Location: Situated in northern Thailand.</li>
                            <li>Language: Thai</li>
                            <li>Currency: Thai bhat.</li>
                            <li>Significance: Chiang Mai, northern Thailand's cultural hub, is renowned for its ancient temples, traditional handicrafts, and gateway status to the region's mountainous treasures.</li>
						...
						<ul>
                            ...
                            <li>Old City Temples (including Wat Chedi Luang, Wat Phra Singh, Wat Chiang Man)</li>
                            <li>Chiang Mai Night Bazaar</li>
                            <li>Doi Inthanon National Park</li>
                            <li>Bua Thong Sticky Waterfalls</li>
                            <li>Huay Tung Tao Lake</li>
						</ul>
				...
				<div class="recommendation">
					...
					<p>If you are seeking an exceptional lodging experience during your visit to Chiang-Mia,Thailand, we highly recommend these hotels </p>
					<div class="row">
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							<img src="switzer-geneva-hotel1.jpg.jpg" class="card-img-top" alt="australia">
							<div class="card-body">
							  <h5 class="card-title">137 Pillars House Chiang Mai:</h5>
							  <p class="card-text">This boutique hotel offers a luxurious stay with its colonial-style architecture, elegant suites, and lush gardens. It's known for exceptional service, a serene ambiance, and historical charm.</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">Anantara Chiang Mai Resort:</h5>
							  <p class="card-text">Located along the Mae Ping River, this resort features contemporary design blended with traditional Thai elements. It offers a tranquil escape with amenities like a riverside pool, spa, and gourmet dining options.</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">Dhara Dhevi Chiang Mai: </h5>
							  <p class="card-text">Set on expansive grounds, this resort resembles a historic Thai palace with its grand architecture and opulent interiors. It provides a unique cultural experience with activities like traditional crafts, cooking classes, and a luxury spa.</p>
							  <a href="#" class="btn btn-primary">Book</a>
							</div>
						  </div>
						</div>
