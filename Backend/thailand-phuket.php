    ...
    <div class="title1">
	  <div>
		<nav class="navbar navbar-expand-lg navbar-light bg-body-dark">
		  ...
		  <h1 style="color: white; padding: 12px; text-align: center; color: red;">Phuket</h1>
		  ...
		  <div class="description">
			<div style="color: white;">
				...
				<p>Phuket, Thailand's largest island and a renowned tourist destination, captivates visitors with its stunning beaches, vibrant nightlife, and rich cultural heritage. From the bustling shores of Patong Beach to the tranquil waters of Kata Beach, Phuket offers a diverse range of experiences for travelers seeking relaxation, adventure, and exploration. Beyond its pristine coastline, the island boasts historic temples, vibrant markets, and an array of outdoor activities, including island hopping, diving, and jungle adventures. With its vibrant culinary scene, lively nightlife, and endless opportunities for relaxation and adventure, Phuket promises an unforgettable tropical getaway for visitors from around the world.</p>
			</div>
		  </div>
		  ...
		  <div class="container">
					...
					<div class="details">
						...
						<p> Here are the details for visiting Phuket,Thailand :</p>
						
						<b>Overview:</b>
						<ul>
							<li>Location:  Phuket is Thailand's largest island located in the Andaman Sea, off the southwest coast of the country.</li>
                            <li>Language:Thai is the primary language spoken in Phuket.</li>
                            <li>Curreny:The currency used in Phuket, as in the rest of Thailand, is the Thai Baht (THB)..</li>
                            <li>Significance: Phuket is a significant tourist destination known for its stunning beaches, vibrant nightlife, and rich cultural heritage, attracting millions of visitors from around the world each year.</li>
				...
				<div class="recommendation">
					...
					<p>If you are seeking an exceptional lodging experience during your visit to Phuket,Thailand, we highly recommend these hotels </p>
					<div class="row">
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							<img src="switzer-geneva-hotel1.jpg.jpg" class="card-img-top" alt="australia">
							<div class="card-body">
							  <h5 class="card-title">The Nai Harn</h5>
							  <p class="card-text">Located on one of Phuket's most beautiful beaches, The Nai Harn offers elegant rooms with breathtaking views of the ocean or surrounding hills, along with excellent dining and leisure facilities.</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">Trisara Phuket: </h5>
							  <p class="card-text">Known for its luxurious private pool villas overlooking the Andaman Sea, Trisara offers a serene and exclusive retreat with impeccable service.</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">Sri Panwa Phuket: </h5>
							  <p class="card-text">This resort boasts stunning ocean views and spacious villas equipped with infinity pools. It's renowned for its vibrant atmosphere and top-notch dining options.</p>
							  <a href="#" class="btn btn-primary">Book</a>
							</div>
						  </div>
						</div>
