    ...
    <div class="title1">
	  <div>
		<nav class="navbar navbar-expand-lg navbar-light bg-body-dark">
		  ...
		  <h1 style="color: white; padding: 12px; text-align: center; color: red;">Geneva</h1>
		  ...
		  <div class="description">
			<div style="color: white;">
				...
				<p>Nestled on Lake Geneva and surrounded by mountains, Geneva is a cosmopolitan city known for its international organizations like the UN and the Red Cross. Explore its rich culture through museums, art galleries, and the historic Old Town with landmarks like St. Pierre Cathedral. Highlights include the Jet d'Eau fountain, fine dining, luxury shopping, and serene parks. Geneva also offers outdoor adventures like skiing and sailing, making it a must-visit destination.</p>
			</div>
		  </div>
		  ...
		  <div class="container">
					...
					<div class="details">
						...
						<b>Overview:</b>
						<ul>
							<li>Location: Situated on the shores of Lake Geneva, surrounded by the Alps and Jura mountains in southwestern Switzerland.</li>
                            <li>Language: French is the official language, but English and other languages are widely spoken due to its international population.</li>
                            <li>Currency: Swiss Franc (CHF).</li>
                            <li>Significance: A global hub for diplomacy and finance, home to the United Nations, the Red Cross, and numerous other international organizations.</li>
						...
						<ul>
							<li>Jet d'Eau</li>
                            <li>Old Town (Vieille Ville)</li>
                            <li>United Nations Office</li>
                            <li>International Red Cross and Red Crescent Museum</li>
                            <li>Museum of Art and History</li>
                            <li>The Flower Clock (L'Horloge Fleurie)</li>
						</ul>
				...
				<div class="recommendation">
					...
					<p>If you are seeking an exceptional lodging experience during your visit to Geneva,Switzerland, we highly recommend these hotels </p>
					<div class="row">
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							<img src="switzer-geneva-hotel1.jpg.jpg" class="card-img-top" alt="australia">
							<div class="card-body">
							  <h5 class="card-title"> Hotel d'Angleterre:</h5>
							  <p class="card-text">A luxurious five-star hotel offering elegant, individually decorated rooms with stunning views of Lake Geneva and the Jet d'Eau. Known for its impeccable service and refined atmosphere.</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">Beau-Rivage Genève:</h5>
							  <p class="card-text"> A historic five-star hotel offering timeless elegance and luxurious accommodations with views of Lake Geneva and Mont Blanc. Known for its rich history and exceptional hospitality.</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">Four Seasons Hotel des Bergues Geneva:</h5>
							  <p class="card-text"> A prestigious five-star hotel blending historic charm with modern luxury, featuring spacious rooms and suites with lake or city views. Renowned for its world-class service and opulent setting.</p>
							  <a href="#" class="btn btn-primary">Book</a>
							</div>
						  </div>
						</div>
