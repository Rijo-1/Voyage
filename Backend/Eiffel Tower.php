...
$location_id = 15; // Assuming 1 is the location_id for Eiffel Tower
...
<body>
    <div class="title1">
        <div>
            ...
            <h1 style="color: white; padding: 12px; text-align: center; color: red;">Eiffel Tower</h1>
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="./eiffel3.jpg" alt="Third slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="./eiffel4.jpg" alt="Fourth slide">
                    </div>
                    <div class="carousel-item">
            ...
            <div class="description">
                <div style="color: white;">
                    ...
                    <p>The Eiffel Tower, an iconic symbol of France, stands tall on the Champ de Mars in Paris. Completed in 1889 for the Exposition Universelle (World's Fair), it was designed by the engineer Gustave Eiffel and has become one of the most recognized structures in the world. The tower is 324 meters tall and offers breathtaking views of Paris from its observation decks.</p>
                </div>
            </div>
            ...
            <div class="container">
                <div class="details">
                    ...
                    <p>Here are the details for visiting the Eiffel Tower:</p>
                    
                    <b>Timings:</b>
                    <ul>
                        <li>The Eiffel Tower is open every day of the year from 9:30 AM to 11:45 PM, with extended hours in summer (mid-June to early September) from 9 AM to 12:45 AM.</li>
                    </ul>

                    <b>Entry Fare:</b>
                    <ul>
                        <li>Ticket prices vary depending on the level you wish to visit. Tickets can be purchased online or at the ticket counters at the tower's base.</li>
                    </ul>
                ...
                <div class="reviews">
                    ...
                    <form id="reviewForm" method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type
                            ="text" class="form-control" id="location_id" name="location_id" value="15" readonly>
                        </div>
                        <div class="form-group">
                ...
                <div class="recommendation">
                    ...
                    <p>For a luxurious stay near the Eiffel Tower, consider these nearby hotels:</p>
                        ...
                        <div class="col-md-4">
                            <div class="card" style="width: 24rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="https://www.fourseasons.com/paris/" class="btn btn-primary">Check out</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="card" style="width: 24rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="https://www.peninsula.com/en/paris/5-star-luxury-hotel-16th-arrondissement" class="btn btn-primary">Check out</a>
                                </div>
                            </div>
                        </div>
                    </div>
