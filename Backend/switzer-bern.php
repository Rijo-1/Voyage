    ...
    <div class="title1">
	  <div>
		<nav class="navbar navbar-expand-lg navbar-light bg-body-dark">
		  ...
		  <h1 style="color: white; padding: 12px; text-align: center; color: red;">Bern</h1>
		  ...
		  <div class="description">
			<div style="color: white;">
				...
				<p>Bern, the capital city of Switzerland, is built around a crook in the Aare River. It traces its origins back to the 12th century, with medieval architecture preserved in the Altstadt (Old Town). The Swiss Parliament and diplomats meet in the Neo-Renaissance Bundeshaus (Federal Palace). The Französische Kirche (French Church) and the nearby medieval tower known as the Zytglogge both date to the 13th century.</p>
			</div>
		  </div>
		  ...
		  <div class="container">
					...
					<div class="details">
						...
						<p> Here are the details for visiting Bern,Switzerland :</p>
						
						<b>Overview:</b>
						<ul>
							
							<li>Location: Bern is situated in the west-central part of Switzerland, nestled along the Aare River.</li>
                            <li>Language: The official language is Swiss German, but English and French are also widely spoken.</li>
                            <li>Currency: Swiss Franc (CHF).</li>
                            <li>Significance: Bern is the capital city of Switzerland, known for its well-preserved medieval architecture and as the political center of the country, hosting the Swiss federal government.
                                </li>
						...
						<b>Top Attractions:</b>
						<ul>
							<li>Old Town (Altstadt)</li>
                            <li>Zytglogge (Clock Tower)</li>
                            <li>Bern Cathedral (Berner Münster)</li>
                            <li>Rosengarten (Rose Garden)</li>
                            <li>Federal Palace (Bundeshaus)</li>
						</ul>
				...
				<div class="recommendation">
					...
					<p>If you are seeking an exceptional lodging experience during your visit to Bern,Switzerland, we highly recommend these hotels </p>
					<div class="row">
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							<img src="zermatt_hotel_1.jpg" class="card-img-top" alt="australia">
							<div class="card-body">
							  <h5 class="card-title"> Hotel Bellevue Palace Bern:</h5>
							  <p class="card-text">A luxurious five-star hotel with a rich history, offering elegant rooms and suites with stunning views of the Bernese Alps and the Aare River. Known for its refined ambiance and top-notch service.
								</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">Hotel Schweizerhof Bern & Spa:</h5>
							  <p class="card-text">A prestigious five-star hotel combining historic charm with modern luxury, featuring sophisticated rooms and a renowned spa. Ideal for both leisure and business travelers.</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">Hotel Allegro Bern:</h5>
							  <p class="card-text">A contemporary four-star hotel with a vibrant atmosphere, offering comfortable accommodations and panoramic views of the city. Known for its excellent hospitality and central location.</p>
							  <a href="#" class="btn btn-primary">Book</a>
							</div>
						  </div>
						</div>
