    ...
    <div class="title1">
	  <div>
		<nav class="navbar navbar-expand-lg navbar-light bg-body-dark">
		  ...
		  <h1 style="color: white; padding: 12px; text-align: center; color: red;">Zurich</h1>
		  ...
		  <div class="description">
			<div style="color: white;">
				...
				<p>Zurich, Switzerland's largest city, is a vibrant financial and cultural hub set on the picturesque shores of Lake Zurich, with the Alps as a stunning backdrop. Blending historic charm with modern sophistication, Zurich features a well-preserved medieval old town, world-class museums, upscale shops, gourmet restaurants, and lively nightlife. Outdoor enthusiasts can enjoy boating on the lake, hiking nearby mountains, and exploring scenic parks. Renowned for its high quality of life, Zurich also boasts efficient public transportation and a major international airport, making it a convenient gateway to Switzerland and beyond.</p>
			</div>
		  </div>
		  ...
		  <div class="container">
					...
					<div class="details">
						...
						<p> Here are the details for visiting Zurich,Switzerland :</p>
						
						<b>Overview:</b>
						<ul>
							
							<li>Location: Situated on the northern shore of Lake Zurich, with the Alps visible in the distance, in the central part of Switzerland.</li>
                            <li>Language: The primary language is Swiss German, but English and French are widely spoken.</li>
                            <li>Currency: Swiss Franc (CHF).</li>
                            <li>Significance: Zurich is Switzerland’s largest city and its main financial and cultural hub, home to numerous banks, multinational corporations, and cultural institutions.</li>
						</ul>
		
						<b>Top Attractions:</b>
						<ul>
							<li>Olild Town (Altstadt) </li>
                            <li>Kunsthaus Zurich </li>
                            <li>Bahnhofstrasse </li>
                            <li>Lake Zurich </li>
                            <li>Swiss National Museum (Landesmuseum Zürich) </li>
						</ul>
				...
				<div class="recommendation">
					...
					<p>If you are seeking an exceptional lodging experience during your visit to Zurich,Switzerland, we highly recommend these hotels </p>
					<div class="row">
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							<img src="zermatt_hotel_1.jpg" class="card-img-top" alt="australia">
							<div class="card-body">
							  <h5 class="card-title"> Baur au Lac:</h5>
							  <p class="card-text">A luxurious five-star hotel set in its own private park, offering stunning views of Lake Zurich and the Alps. Known for its elegance, impeccable service, and historic charm.
								</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">The Dolder Grand:</h5>
							  <p class="card-text">A grand five-star hotel perched on a hill overlooking Zurich, blending traditional elegance with modern amenities. Renowned for its luxurious spa and art collection.</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">Park Hyatt Zurich:</h5>
							  <p class="card-text">A contemporary five-star hotel located in the heart of Zurich, offering modern luxury and sophisticated design. Ideal for both business and leisure travelers.</p>
							  <a href="#" class="btn btn-primary">Book</a>
							</div>
						  </div>
						</div>
