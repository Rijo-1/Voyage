    ...
    <div class="title1">
	  <div>
		<nav class="navbar navbar-expand-lg navbar-light bg-body-dark">
		  ...
		  <h1 style="color: white; padding: 12px; text-align: center; color: red;">Ayutthaya</h1>
		  ...
		  <div class="description">
			<div style="color: white;">
				...
				<p>Ayutthaya, officially known as Phra Nakhon Si Ayutthaya, is a city in Thailand that served as the capital of the Ayutthaya Kingdom from 1350 until its destruction by the Burmese in 1767. Located in the Chao Phraya River valley, the city was a major trading hub and one of the world's largest and wealthiest urban areas during its peak. Ayutthaya is renowned for its impressive historical ruins, including grand palaces, Buddhist temples, and monasteries, which reflect its past glory and significance. Today, Ayutthaya is a UNESCO World Heritage Site, attracting numerous visitors interested in its rich cultural heritage and architectural marvels.</p>
			</div>
		  </div>
		  ...
		  <div class="container">
					...
					<div class="details">
						...
						<p> Here are the details for visiting Ayutthaya,Thailand :</p>
						
						<b>Overview:</b>
						<ul>
							<li>Location:Ayutthaya is located in central Thailand, approximately 85 kilometers (53 miles) north of Bangkok. The city is situated in the Chao Phraya River valley</li>
                            <li>Language: The primary language spoken in Ayutthaya, both historically and in modern times, is Thai.</li>
                            <li>Currency: Thai Baht, abbreviated as THB.</li>
                            <li>Significance: Ayutthaya, the capital of the Ayutthaya Kingdom from 1350 to 1767, is significant for its historical, cultural, and architectural heritage. Once one of the world's largest and wealthiest cities, it was a major center for trade, diplomacy, and Buddhism in Southeast Asia. The city is renowned for its impressive ruins, including temples and palaces, reflecting a blend of cultural influences from around the world. Designated a UNESCO World Heritage Site in 1991, Ayutthaya remains a symbol of Thailand's rich history and resilience.</li>
						...
						<ul>
                            ...
                            <li>Ayutthaya Historical Park</li>
                            <li>Wat Chaiwatthanaram</li>
                            <li>Bang Pa-In Royal Palac</li>
						</ul>
				...
				<div class="recommendation">
					...
					<p>If you are seeking an exceptional lodging experience during your visit to Ayutthaya,Thailand, we highly recommend these hotels </p>
					<div class="row">
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							<img src="switzer-geneva-hotel1.jpg.jpg" class="card-img-top" alt="australia">
							<div class="card-body">
							  <h5 class="card-title"> Sala Ayutthaya:</h5>
							  <p class="card-text">This boutique hotel offers luxurious accommodation with stunning views of the Chao Phraya River. It features stylish rooms, an infinity pool, and a rooftop bar overlooking the historic city.</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">Kantary Hotel Ayutthaya:</h5>
							  <p class="card-text">  Located near the Ayutthaya Historical Park, this hotel offers spacious suites with modern amenities. It boasts a beautiful riverside setting, an outdoor pool, and a fitness center.</p>
						...
						<div class="col-md-4">
						  <div class="card" style="width: 24rem;">
							...
							<div class="card-body">
							  <h5 class="card-title">Baan Thai House Ayutthaya:</h5>
							  <p class="card-text"> Situated amidst lush gardens, this charming hotel provides traditional Thai-style accommodation in teakwood houses. Guests can enjoy a tranquil atmosphere, an outdoor pool, and complimentary bicycles for exploring the city.</p>
							  <a href="#" class="btn btn-primary">Book</a>
							</div>
						  </div>
						</div>
